...
def rotmat_to_rot6d(rotation_matrix):
    ...
    return rotation_matrix[..., :3, :2].reshape(rotation_matrix.shape[:-2] + (6,))
...
def angle_axis_to_rot6d(angle_axis):
    """
    Convert angle-axis to 6D rotation representation via rotation matrix
    """
    rotation_matrix = angle_axis_to_rotation_matrix(angle_axis)
    return rotmat_to_rot6d(rotation_matrix)

def rot6d_to_angle_axis(rot6d):
    """
    Convert 6D rotation representation to angle-axis via rotation matrix
    """
    rotation_matrix = rot6d_to_rotmat(rot6d)
