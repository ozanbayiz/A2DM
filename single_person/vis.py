...
class MotionVisualizer:
    ...
    def __init__(self, 
                ...
                offset: np.ndarray = np.array([2.0, 0.0, 0.0])):
        """
    ...
    def update_mesh(self, mesh, joint_data, frame_idx, apply_offset=False):
        """
        ...
        Args:
            ...
            apply_offset: Whether to apply offset (for reconstructed mesh)
        """
    ...
    def run_animation_loop(self, gt_joint_data, recon_joint_data, fps=25):
        ...
        try:
            while True:
                # Update both meshes
                self.update_mesh(self.gt_mesh, gt_joint_data, frame_idx, apply_offset=False)
                self.update_mesh(self.recon_mesh, recon_joint_data, frame_idx, apply_offset=True)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--viz_offset", type=float, nargs=3, default=[2.0, 0.0, 0.0],
